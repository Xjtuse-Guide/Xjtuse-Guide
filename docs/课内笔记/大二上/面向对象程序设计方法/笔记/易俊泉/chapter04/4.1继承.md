...
- 以电子产品商店为例，进行继承说明：
  ...
  根据以上信息，首先抽象出类Product,它派生出子类Computer, Computer类又派生出它的子类Laptop，这三个类的关系图用UML图表示如下：![在这里插入图片描述](https://note-image-1307786938.cos.ap-beijing.myqcloud.com/typora/%206a08102a358a4742a95cbec644e33158.png)
